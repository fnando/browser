...
module Browser
  module Aliases
    ...
    DEVICE_ALIASES = %w[
      ...
      kindle_fire? mobile? nintendo? nintendo_wii? nintendo_wiiu?
      nintendo_switch? playbook? playstation3? playstation4? playstation?
      playstation_vita? ps3? ps4? psp? psp_vita? silk? surface? tablet?
      tv? vita? wii? wiiu? xbox? xbox_360? xbox_one?
    ].freeze
